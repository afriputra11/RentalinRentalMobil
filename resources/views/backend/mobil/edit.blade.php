            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Update Mobil</h5>
                        <small class="text-muted float-end">Default label</small>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('upadteMobilStore') }}" method="post" id="add-mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_mobil" name="nama_mobil"
                                        value="{{ $mobil->nama_mobil }}" placeholder="Nama Mobil" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_pol" name="no_pol"
                                        value="{{ $mobil->no_pol }}" placeholder="BA 1234 XX" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="warna" name="warna" value="{{ $mobil->warna }}"
                                            class="form-control" placeholder="Warna Mobil" aria-label="Warna Mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="th_mobil" name="th_mobil" value="{{ $mobil->th_mobil }}"
                                        class="form-control phone-mask" placeholder="Tahun Mobil" aria-label="Tahun Mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="merk_mobil" name="merk_mobil" value="{{ $mobil->merk_mobil }}"
                                        class="form-control phone-mask" placeholder="Merk Mobil" aria-label="Merk Mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" id="img_mobil" name="image" value="{{ $mobil->img_mobil }}"
                                        class="form-control phone-mask" placeholder="Foto Mobil" aria-label="Foto Mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="harga_sewa" name="harga_sewa"
                                        value="{{ $mobil->harga_sewa }}" class="form-control phone-mask"
                                        placeholder="Harga Sewa Perhari" aria-label="Harga Sewa Perhari"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="denda_sewa" name="denda_sewa"
                                        value="{{ $mobil->denda_sewa }}" class="form-control phone-mask"
                                        placeholder="Denda Sewa Perhari" aria-label="Denda Sewa Perhari"
                                        aria-describedby="denda_sewa" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="status">Status Mobil</label>
                                <div class="col-sm-10">
                                    <input type="text" id="status" name="status" value="{{ $mobil->status }}"
                                        class="form-control phone-mask" placeholder="Status" aria-label="Status"
