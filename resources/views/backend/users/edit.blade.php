        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('upadteUserAdminStore') }}" method="post" id="add-user"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nik" name="nik"
                                        value="{{ $user->nik }}" placeholder="NIK" maxlength="16"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="tgl_lahir" name="tgl_lahir" value="{{ $user->tgl_lahir }}"
                                        class="form-control phone-mask" placeholder="Tgl Lahir" aria-label="Tgl Lahir"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <select name="j_kel" id="j_kel" class="form-control">
                                            ...
                                            <option value="1" {{ $user->j_kel == '1' ? 'Selected' : '' }}>Laki - Laki
                                            </option>
                                            <option value="2" {{ $user->j_kel == '2' ? 'Selected' : '' }}>Perempuan
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="no_hp" name="no_hp" value="{{ $user->no_hp }}"
                                        class="form-control phone-mask" placeholder="No HP" aria-label="No HP"
                                        aria-describedby="no_hp" maxlength="13" onkeypress="return hanyaAngka(event)" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="pekerjaan">Pekerjaan</label>
                                <div class="col-sm-10">
                                    <input type="text" id="pekerjaan" name="pekerjaan" value="{{ $user->pekerjaan }}"
                                        class="form-control phone-mask" placeholder="Pekerjaan" aria-label="Pekerjaan"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="alamat" name="alamat" value="{{ $user->alamat }}"
                                        class="form-control phone-mask" placeholder="Alamat" aria-label="Alamat"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" id="email" name="email" value="{{ $user->email }}"
                                        class="form-control phone-mask" placeholder="Email" aria-label="Email"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" id="password" name="password"
                                        class="form-control phone-mask" placeholder="Password" aria-label="Password"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <select name="roles" id="roles" class="form-control">
                                            ...
                                            <option value="1" {{ $user->roles == '1' ? 'Selected' : '' }}>Admin
                                            </option>
                                            <option value="2" {{ $user->roles == '2' ? 'Selected' : '' }}>User
                                            </option>
                                        </select>
                                    </div>
                                </div>
