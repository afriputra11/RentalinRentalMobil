        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('upadteRekeningStore') }}" method="post" id="add-mobil"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nama_rek" name="nama_rek"
                                        value="{{ $rekening->nama_rek }}" placeholder="Nama Pemilik Rekening" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="jenis_bank"
                                        value="{{ $rekening->jenis_bank }}" name="jenis_bank" placeholder="Nama Bank" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="no_rek" name="no_rek" value="{{ $rekening->no_rek }}"
                                            class="form-control" placeholder="No Rekening" aria-label="No Rekening"
