        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('updateMobilRentaldminStore') }}" method="post" id="update-rental"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="id_tuser" name="id_tuser"
                                        value="{{ $user->nama }}" disabled placeholder="Nama Lengkap" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_hp" name="no_hp"
                                        value="{{ $user->no_hp }}" disabled placeholder="No HP" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                    ...
                                    <select name="id_mobil" id="id_mobil" class="form-control">
                                        ...
                                        @foreach ($mobil as $m)
                                            <option value="{{ $m->id_mobil }}"
                                                {{ $user->id_mobil == $m->id_mobil ? 'Selected' : '' }}>
                                                {{ $m->merk_mobil }} {{ $m->nama_mobil }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="tgl_rental" name="tgl_rental" value="{{ $user->tgl_rental }}"
                                        class="form-control phone-mask" placeholder="Tgl Rental" aria-label="Tgl Rental"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="tgl_kembali" name="tgl_kembali"
                                        value="{{ $user->tgl_kembali }}" class="form-control phone-mask"
                                        placeholder="Tgl Kembali" aria-label="Tgl Kembali" aria-describedby="tgl_kembali" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <select name="cara_bayar" id="cara_bayar" class="form-control">
                                            ...
                                            <option value="1" {{ $user->cara_bayar == '1' ? 'Selected' : '' }}>
                                                Transfer</option>
                                            <option value="2" {{ $user->cara_bayar == '2' ? 'Selected' : '' }}>Tunai
                                            </option>
                                        </select>
                                    </div>
                                </div>
