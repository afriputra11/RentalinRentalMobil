                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <div>
                            ...
                            <a class="review-link" href="#">Tahun {{ substr($data->th_mobil, 0, 4) }} |
                                {{ $data->no_pol }}</a>
                        </div>
                        <div>
                            <h3 class="product-price">Rp. {{ number_format($data->harga_sewa) }} /Hari</h3>
                            <span class="product-available"><?php if ($data->status == 1) {
                                echo 'Ready';
                            } ?></span>
                        </div>
                        <p>Mobil {{ $data->nama_mobil }} Tahun {{ substr($data->th_mobil, 0, 4) }} Warna
                            {{ $data->warna }}. Harga sewa Rp. {{ number_format($data->harga_sewa) }}/Hari lepas kunci,
                            untuk pengembalian lewat dari tanggal kembali yang telah disepakati akan dikenakan denda
                            sebanyak Rp. {{ number_format($data->denda_sewa) }}/hari</p>
                        ...
                        <form action="{{ route('addMobilRental') }}" method="post" id="create-rental">
                            ...
                            <div class="product-options">
                                <label>
                                    Tanggal Rental
                                    <input type="date" id="tgl_rental" style="width: 200px" onChange="cekTgl()"
                                        class="input-select">
                                </label><br><br>
                                <label>
                                    Tanggal Kembali
                        ...
                        <div class="product">
                            ...
                            <div class="add-to-cart">
                                <a href="{{ route('getMobilDetail', $value->id_mobil) }}">
                                    <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Rental
                                        Sekarang</button>
                                </a>
                            </div>
                        </div>
